...
mass_fuel <- dplyr::filter(emissions_long, metric == "mass_carbon") %>%
               ...
               dplyr::summarise(mass_carbon = sum(value, na.rm = TRUE)) #since grav = 0 and ECOC not included as of 6/29/17, this number is bad? it's the mass of carbon emitted, not mass of pollutant emitted. 
```
