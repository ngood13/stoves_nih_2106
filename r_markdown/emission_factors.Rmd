...
## mass pollutant (mg) per kg fuel burnt
```{r, fig.width= 15, fig.height= 20}
ggplot(dplyr::filter(emission_factors, metric == "mass_carbon"), aes(x = id, y = mass_ef, color = fuel_type)) +
    geom_point() +
    theme_minimal() +
    scale_y_log10() +
    facet_grid(pol ~ fuel_type, scales = "free_x") +
    theme(axis.text.x = element_text(angle = 60, hjust = 1)) +
    ggtitle("mass of pollutant emitted per kg of fuel burnt")
```
